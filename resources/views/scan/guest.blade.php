...
<div class="card" style="text-align: center;">
    <div class="equipment-header">
        ...
        <p style="color: var(--text-muted); margin-bottom: 2rem;">عذراً، يجب عليك تسجيل الدخول بحساب موظف المستشفى للوصول إلى تفاصيل الآلة: <strong style="color: var(--text-main);">{{ $equipment->name }}</strong>.</p>
    </div>
